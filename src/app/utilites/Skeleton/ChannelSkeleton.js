  ...
  return (
    <>
      <div className=" py-8 min-h-screen max-w-screen-2xl m-auto px-10 sm:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 items-center gap-6 mb-3.5">
          ...
          <div
            role="status"
            class="flex items-center justify-center h-72 max-w-xl bg-gray-300 rounded-lg animate-pulse dark:bg-gray-700"
          >
            <svg
